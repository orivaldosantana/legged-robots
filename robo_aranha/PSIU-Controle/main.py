...
from programacao import Ui_Programacao
...
def scan():
    return glob.glob('/dev/ttyU*') +  glob.glob('/dev/ttyA*') + glob.glob('/dev/rfcomm*')
...
class MainWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        #
        self.lineEditAvancadoNormal = QtGui.QLineEdit(self.aba3)
        self.lineEditAvancadoNormal.setGeometry(QtCore.QRect(35, 55, 600, 27))
        self.lineEditAvancadoNormal.setText(QtGui.QApplication.translate("Form", "", None, QtGui.QApplication.UnicodeUTF8))
        self.lineEditAvancadoNormal.setObjectName(_fromUtf8("radioButtonBigLineEdit"))
        #
        ...
        self.botaoEnviarComando.setText(QtGui.QApplication.translate("Form", "Enviar Comando ASCII", None, QtGui.QApplication.UnicodeUTF8))
	...
	self.lineEditAvancadoHexa = QtGui.QLineEdit(self.aba3)
        self.lineEditAvancadoHexa.setGeometry(QtCore.QRect(35, 145, 600, 27))
        self.lineEditAvancadoHexa.setText(QtGui.QApplication.translate("Form", "", None, QtGui.QApplication.UnicodeUTF8))
        self.lineEditAvancadoHexa.setObjectName(_fromUtf8("radioButtonBigLineEdit"))
	
	
        self.botaoEnviarHexa = QtGui.QPushButton(self.aba3)
        self.botaoEnviarHexa.setGeometry(QtCore.QRect(35, 120, 600, 27))
        self.botaoEnviarHexa.setText(QtGui.QApplication.translate("Form", "Enviar Comando HEXA", None, QtGui.QApplication.UnicodeUTF8))
        ...
        #CHECKBOX DA COMPLICAÇÃO
        self.checkBox = QCheckBox(self.aba3)
        self.checkBox.setGeometry(QtCore.QRect(35,80, 600, 27))
        self.checkBox.setText(QtGui.QApplication.translate("Form", "Sem complicação", None, QtGui.QApplication.UnicodeUTF8))
	#FIM DO CHECKBOX DA COMPLICAÇÃO
        self.menuDeAbas.addTab(self.aba3, _fromUtf8(""))
      ...
      #ABA DA PROGRAMAÇÃO
        ...
        self.aba4 = QtGui.QWidget()
        self.aba4.setObjectName(_fromUtf8("aba_4"))
	self.menuDeAbas.addTab(self.aba4, _fromUtf8(""))
	
	self.programacao = Ui_Programacao()
        self.programacao.setupUi(self.aba4)
        self.programacao.portaSerial.activated[str].connect(self.programacao.escolhaPortaSerial)
        self.programacao.board.activated[str].connect(self.programacao.escolhaBoard)
        self.programacao.upload.clicked.connect(self.programacao.uploadFunction)
        
         
        
        self.aba5 = QtGui.QWidget()
        self.aba5.setObjectName(_fromUtf8("aba_5"))
        self.menuDeAbas.addTab(self.aba5, _fromUtf8(""))
        
        self.web = QtWebKit.QWebView(self.aba5)
        self.web.setGeometry(QtCore.QRect(0, 0, 680, 300))
        self.web.setUrl(QtCore.QUrl(_fromUtf8("http://www.robolivre.org")))
    ...
    def enviarComandoAvancadoNormal(self):
    	if(self.checkBox.checkState() == 0): 	#Se o usuário digitar o CHECKSUM e o TAMANHO da mensagem
    		if (len(self.lineEditAvancadoNormal.text().split(" ")) < 5):
    			self.saidaAba3.imprimirSaida("Sintaxe errada! \n")
    		else:
	    		
	    		#resposta = self.instanciaFuncoes.enviar_mensagem(MainWidget.Serial, self.lineEditAvancadoNormal.text())
			#self.saidaAba3.imprimirSaida("mensagem: " + self.lineEditAvancadoNormal.text() + "\n" + "resposta: " + resposta)
			self.saidaAba3.imprimirSaida("mensagem: " + self.lineEditAvancadoNormal.text() + "\n")
			
    	else: 	#Se a mensagem for simplifcada sem CHECKSUM e TAMANHO
    		mensagem = MainWidget.destinatario + ' ' + self.lineEditAvancadoNormal.text() + ' ' + MainWidget.remetente
    		if ( len(mensagem.split(" ")) < 3):
    			self.saidaAba3.imprimirSaida("Sintaxe errada! \n")
    			
    		else:
			tamanho = self.instanciaFuncoes.contarTamanhoComandoBasico(mensagem)
			mensagem = mensagem.split(" ")
			mensagem.insert(1, tamanho)
			mensagem = mensagem.join(" ") + " "
			checksum = self.instanciaFuncoes.calculachecksum(mensagem)
			mensagem = mensagem + checksum
    			self.saidaAba3.imprimirSaida("mensagem: " + mensagem + "\n")
    			self.instanciaFuncoes.enviar_mensagem(MainWidget.Serial, mensagem)
   ...
   # def escolhaBoard(self, text):
    ...
    def metododoDoMenuDeAbas(self, Form):
        ...
        self.menuDeAbas.setTabText(self.menuDeAbas.indexOf(self.aba4), QtGui.QApplication.translate("Form", "Programação", None, QtGui.QApplication.UnicodeUTF8))
        self.menuDeAbas.setTabText(self.menuDeAbas.indexOf(self.aba5), QtGui.QApplication.translate("Form", "Robô Livre", None, QtGui.QApplication.UnicodeUTF8))
    ...
    def listarComandos(self):
        ...
        self.arrayResposta.append(self.instanciaFuncoes.enviar_mensagem(MainWidget.Serial, MainWidget.mensagem))
    ...
    def constroiMensagem(self):
        ...
        resposta = self.instanciaFuncoes.enviar_mensagem(MainWidget.Serial, MainWidget.mensagem)
    ...
    def enviar(self):
        ...
        mensagem = MainWidget.destinatario + ' ' + MainWidget.comando + ' '+ MainWidget.distancia + ' ' + MainWidget.remetente
        MainWidget.tamanho = self.instanciaFuncoes.contarTamanhoComandoBasico(mensagem)
    ...
    def busca_robos(self):
        ...
        for numero in range(len(scan())):
            ...
            resposta = self.instanciaFuncoes.enviar_mensagem(robo_porta, mensagem)
